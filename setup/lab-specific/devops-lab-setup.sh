...
echo "  Creating a Vaule and master signing key"
...
echo "  Create policies based on the dynamic groups to allow Devops services to run biilds and update your Kubernrtes cluster"
echo ""
