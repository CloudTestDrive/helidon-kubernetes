...
DEVOPS_DEPLOY_ENVIRONMENT_REUSED_NAME=DEVOPS_DEPLOY_ENVIRONMENT_"$DEVOPS_DEPLOY_ENVIRONMENT_NAME_CAPS"_IN_PROJECT_"$DEVOPS_PROJECT_NAME_CAPS"_REUSED
echo $DEVOPS_DEPLOY_ENVIRONMENT_REUSED_NAME