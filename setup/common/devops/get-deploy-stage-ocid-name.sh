...
DEVOPS_DEPLOY_STAGE_OCID_NAME=DEVOPS_DEPLOY_STAGE_"$DEVOPS_DEPLOY_STAGE_NAME_CAPS"_IN_DEPLOY_PIPELINE_"$DEVOPS_DEPLOY_PIPELINE_NAME_CAPS"_IN_PROJECT_"$DEVOPS_PROJECT_NAME_CAPS"_OCID
echo $DEVOPS_DEPLOY_STAGE_OCID_NAME