...
echo oci devops "$PIPELINE_COMMAND" "$PIPELINE_OCID_FLAG" "$DEVOPS_PIPELINE_OCID" "$PARAMS_FLAG" "$DEVOPS_PIPELINE_PARAMS"
oci devops "$PIPELINE_COMMAND" "$PIPELINE_OCID_FLAG" "$DEVOPS_PIPELINE_OCID" "$PARAMS_FLAG" "$DEVOPS_PIPELINE_PARAMS"