...
DEVOPS_BUILD_STAGE_REUSED_NAME=DEVOPS_BUILD_STAGE_"$DEVOPS_BUILD_STAGE_NAME_CAPS"_IN_BUILD_PIPELINE_"$DEVOPS_BUILD_PIPELINE_NAME_CAPS"_IN_PROJECT_"$DEVOPS_PROJECT_NAME_CAPS"_R~EUS~ED
