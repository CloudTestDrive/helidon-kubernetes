...
DEVOPS_DEPLOY_ARTIFACT_OCID_NAME=DEVOPS_DEPLOY_ARTIFACT_"$DEVOPS_DEPLOY_ARTIFACT_NAME_CAPS"_IN_PROJECT_"$DEVOPS_PROJECT_NAME_CAPS"_OCID
echo $DEVOPS_DEPLOY_ARTIFACT_OCID_NAME