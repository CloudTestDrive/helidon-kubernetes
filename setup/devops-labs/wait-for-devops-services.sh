...
if [ $RESP -ne 0 ]
then
  echo "One of more of the services VAULT_REUSED VAULT_KEY SSH_API_KEY_CONFIGURED DYNAMIC_GROUPS_CONFIGURED POLICIES_CONFIGURED did not start within $WAIT_LOOP_COUNT test loops"
