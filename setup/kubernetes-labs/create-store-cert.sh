...
$HOME/keys/step certificate create store.$1.nip.io tls-store-$1.crt tls-store-$1.key --profile leaf --not-after 8760h --no-password --insecure --ca $HOME/keys/root.crt --ca-key $HOME/keys/root.key
