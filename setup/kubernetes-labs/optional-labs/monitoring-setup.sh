...
MONITORING_INSTALLED_NAME=`bash ../../common/settings/to-valid-name.sh "LOGGING_TO_OOSS_WITH_FLUENTD_""$CLUSTER_CONTEXT_NAME"`
...
# origional trying to configure oin prometheus
