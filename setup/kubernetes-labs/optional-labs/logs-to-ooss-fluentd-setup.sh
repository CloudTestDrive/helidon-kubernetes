...
bash $UPDATE_FILE_SCRIPT $S3_CONFIGURED_YAML YOUR_ACCESS_SECRET $KEY_VALUE ^
echo "Secret key id"
bash $UPDATE_FILE_SCRIPT $S3_CONFIGURED_YAML YOUR_ACCESS_KEY $KEY_ACCESS_ID ^
echo "Storage bucket"
bash $UPDATE_FILE_SCRIPT $S3_CONFIGURED_YAML YOUR_BUCKET_NAME $BUCKET_NAME ^
echo "Region"
bash $UPDATE_FILE_SCRIPT $S3_CONFIGURED_YAML YOUR_REGION $OCI_REGION ^
echo "Storage endpoint URL"
bash $UPDATE_FILE_SCRIPT $S3_CONFIGURED_YAML YOUR_STORAGE_ENDPOINT $OOSS_URL ^
